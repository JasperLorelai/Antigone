...
@Name("antigone_cube_mob_keep_on_jumping")
@WrapVanillaGoal.Inner(
		outer = AbstractCubeMob.class,
		className = "CubeMobKeepOnJumpingGoal"
)
public class CubeMobKeepOnJumpingGoal extends AntigoneGoal {
	...
	public CubeMobKeepOnJumpingGoal(Mob mob, SpellData data) {
		super(mob, data);
	}
