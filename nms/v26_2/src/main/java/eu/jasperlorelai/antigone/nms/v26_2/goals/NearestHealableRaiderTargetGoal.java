...
import eu.jasperlorelai.antigone.nms.v26_2.parameters.modifiers.NmsTargetingSelectorParameter;
...
public class NearestHealableRaiderTargetGoal extends AntigoneGoal {
	...
	private static final List<AntigoneParameter<?, ?>> parameters = List.of(
			...
			new EntityTypeParameter<>(LivingEntity.class, LivingEntityMap::fromString, "target-entity-class", Raider.class),
