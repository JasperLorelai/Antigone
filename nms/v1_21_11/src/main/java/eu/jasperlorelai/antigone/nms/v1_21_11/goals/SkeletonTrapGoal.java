...
@WrapVanillaGoal.Exact(net.minecraft.world.entity.animal.equine.SkeletonTrapGoal.class)
public class SkeletonTrapGoal extends AntigoneGoal {

	// SkeletonHorse skeletonHorse
	private static final List<AntigoneParameter<?, ?>> parameters = List.of(MobParameters_v1_21_11.SkeletonHorse);
