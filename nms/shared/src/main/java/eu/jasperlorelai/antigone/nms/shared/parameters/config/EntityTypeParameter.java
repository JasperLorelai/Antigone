...
public class EntityTypeParameter extends ConfigParameter<Class<?>, Class<? extends LivingEntity>> {
	...
	public EntityTypeParameter(@NotNull Function<String, Class<? extends LivingEntity>> fromString, @NotNull String name) {
		this(fromString, name, (Class<? extends LivingEntity>) null);
	}

	public EntityTypeParameter(@NotNull Function<String, Class<? extends LivingEntity>> fromString, @NotNull String name, @Nullable Class<? extends LivingEntity> def) {
	...
	private EntityTypeParameter(Function<String, Class<? extends LivingEntity>> fromString, String name, Default<Class<? extends LivingEntity>> def) {
