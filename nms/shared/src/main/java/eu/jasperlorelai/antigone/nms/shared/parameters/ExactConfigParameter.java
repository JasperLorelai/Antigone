...
public abstract class ExactConfigParameter<T> extends ConfigParameter<Class<T>, T> {
	...
	public ExactConfigParameter(@NotNull @ConfigKey String name, @NotNull Class<T> type, @Nullable ConfigSupplier<T> supplier, @Nullable Default<T> def) {
		super(name, type, supplier, def);
	}

	public ExactConfigParameter(@NotNull @ConfigKey String name, @NotNull Class<T> type, @Nullable ConfigSupplier<T> supplier) {
