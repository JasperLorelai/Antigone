...
public abstract class PrimitiveConfigParameter<T> extends ExactConfigParameter<T> {
	...
	public PrimitiveConfigParameter(@NotNull @ConfigKey String name, @NotNull Class<T> type, @Nullable ConfigSupplier<T> supplier) {
		this(name, type, supplier, null);
	}

	public PrimitiveConfigParameter(@NotNull @ConfigKey String name, @NotNull Class<T> type, @Nullable ConfigSupplier<T> supplier, @Nullable Default<T> def) {
