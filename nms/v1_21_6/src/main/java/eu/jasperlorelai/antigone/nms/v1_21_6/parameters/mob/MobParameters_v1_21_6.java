package eu.jasperlorelai.antigone.nms.v1_21_6.parameters.mob;
...
public class MobParameters_v1_21_6 {
	...
	public static final MobParameter<Pufferfish> Pufferfish = with(Pufferfish.class, Description.ofClass(PufferFish.class));
	...
	public static final MobParameter<ShoulderRidingEntity> ShoulderRidingEntity = with(ShoulderRidingEntity.class, Description.ofClass(Parrot.class));
	...
	public static final MobParameter<EnderMan> EnderMan = with(EnderMan.class, Description.ofClass(Enderman.class));
	...
	public static final MobParameter<SpellcasterIllager> SpellcasterIllager = with(SpellcasterIllager.class, Description.ofClass(Spellcaster.class));
	public static final MobParameter<Vex> Vex = with(Vex.class, Description.ofClass(org.bukkit.entity.Vex.class));
	public static final MobParameter<WitherBoss> WitherBoss = with(WitherBoss.class, Description.ofClass(Wither.class));
