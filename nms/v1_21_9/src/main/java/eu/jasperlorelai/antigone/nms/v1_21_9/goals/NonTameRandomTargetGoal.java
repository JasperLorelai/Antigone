...
import eu.jasperlorelai.antigone.nms.v1_21_9.entities.LivingEntityMap;
...
import eu.jasperlorelai.antigone.nms.v1_21_9.parameters.modifiers.NmsTargetingSelectorParameter;
...
public class NonTameRandomTargetGoal extends AntigoneGoal {
	...
	private static final List<AntigoneParameter<?, ?>> parameters = List.of(
			...
			MobParameters_v1_21_9.TamableAnimal,
