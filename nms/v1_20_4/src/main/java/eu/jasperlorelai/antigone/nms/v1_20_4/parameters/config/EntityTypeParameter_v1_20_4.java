...
public class EntityTypeParameter_v1_20_4 extends EntityTypeParameter {

	public EntityTypeParameter_v1_20_4(@NotNull String name) {
		this(name, null);
	}

	public EntityTypeParameter_v1_20_4(@NotNull String name, @Nullable Class<? extends LivingEntity> def) {
		super(name, def);
	}
