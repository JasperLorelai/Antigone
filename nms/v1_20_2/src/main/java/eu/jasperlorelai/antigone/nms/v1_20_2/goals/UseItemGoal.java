...
import eu.jasperlorelai.antigone.nms.v1_20_2.parameters.config.NmsItemStackParameter_v1_20_2;
...
public class UseItemGoal extends AntigoneGoal {
	...
	private static final List<AntigoneParameter<?, ?>> parameters = List.of(
			// T extends Mob actor
			MobParameters_v1_20_2.getInstance().Mob,
			// ItemStack item
			new NmsItemStackParameter_v1_20_2("item"),
