...
import eu.jasperlorelai.antigone.nms.v1_20_2.parameters.config.EntityTypesParameter_v1_20_2;
...
public class HurtByTargetGoal extends AntigoneGoal {
	...
	private static final List<AntigoneParameter<?, ?>> parameters = List.of(
			...
			new EntityTypesParameter_v1_20_2("no-revenge-types", EntityTypesParameter_v1_20_2.EMPTY)
	);
